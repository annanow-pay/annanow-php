...
$invoice = new \Annanow\Models\Request\Invoice();
...
$invoice->setDescription('Thanks for using Annanow to pay your order');

// administrative information, which provider to use (psp)
// psp #1 = Annanow' test mode, see http://developers.annanow-pay.com/docs/miscellaneous
//$invoice->setPsp([]);
...
// http://developers.annanow-pay.com/docs/miscellaneous
...
try {
    $response = $annanow->create($invoice);
    var_dump($response);
