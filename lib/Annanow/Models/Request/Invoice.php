 ...
 */
class Invoice extends \Annanow\Models\Base
{
     ...
     * can be found here: http://developers.annanow-pay.com/docs/miscellaneous
     *
     * @param int $psp
     */
     ...
     * This name will only be shown to administrator of the Annanow site.
     *
     * @param string $name
     */
     ...
     * A list of available currencies you can find on http://developers.annanow-pay.com/docs/miscellaneous
     *
    ...
    {
        return new \Annanow\Models\Response\Invoice();
    }
}
