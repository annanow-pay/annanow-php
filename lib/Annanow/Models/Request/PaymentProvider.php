 ...
 *
 * @author    Annanow Development <dev@annanow-pay.com>
 * @copyright 2018 Annanow
 * @since     v1.0
 */
 ...
 */
class PaymentProvider extends \Annanow\Models\Base
{
    /** @var string $name */
    protected $name;
    ...
    {
        return new \Annanow\Models\Response\PaymentProvider();
    }
}
